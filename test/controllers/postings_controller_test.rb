...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { posting_title: @posting.posting_title, truck_id: @posting.truck_id } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { posting_title: @posting.posting_title, truck_id: @posting.truck_id } }
